...
import { StateUpdatesHttpClientV1 } from '../../src/version1/StateUpdatesHttpClientV1';
...
suite('StateUpdatesHttpClientV1', ()=> {
    let service: StateUpdatesHttpServiceV1;
    let client: StateUpdatesHttpClientV1;
    ...
    suiteSetup((done) => {
        ...
        client = new StateUpdatesHttpClientV1();
